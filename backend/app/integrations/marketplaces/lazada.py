...
LAZADA_PROVIDER = ProviderDefinition(
    key="lazada",
...
def is_enabled() -> bool:
    return env_flag("LAZADA_OPEN_PLATFORM_ENABLED", False)


def is_configured() -> bool:
    return bool(env_text("LAZADA_APP_KEY") and env_text("LAZADA_APP_SECRET"))
