...
async def get_sales_orders(
    ...
    _ = current_user
    return list_sales_orders(db, status_filter)
...
async def confirm_order(
    ...
    _ = current_user
    return confirm_sales_order(db, sales_order_id)
...
async def fulfill_order_item(
    ...
    _ = current_user
    return fulfill_sales_order_item(db, order_id=order_id, item_id=item_id, quantity=payload.quantity)
